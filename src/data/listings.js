...
export const listings = [
    {
        id: 1,
        title: "Học bổng Samsung Talent Scholarship",
        type: "scholarship",
        amount: 20000000,
        unit: "VND",
        cohorts: ["K69", "K68"],
...
Áp dụng cho K69, K68. Ưu tiên sinh viên tham gia nghiên cứu khoa học.`,
    ...
    {
        id: 2,
        title: "Gia sư Toán lớp 9 (Quận Hai Bà Trưng)",
        type: "job",
        amount: 120000,
        unit: "VND/hour",
        cohorts: ["K67", "K66", "K65"],
...
Yêu cầu: điểm Toán > 8, có kỹ năng sư phạm. Áp dụng cho sinh viên K67–K65.`,
    ...
    {
        id: 3,
        title: "Trợ lý Phòng thí nghiệm Vật Liệu (HUST)",
        type: "job",
        amount: 90000,
        unit: "VND/hour",
        cohorts: ["K69", "K68", "K67"],
...
Ưu tiên sinh viên nắm vững an toàn phòng thí nghiệm và GPA ≥ 2.8.`,
    ...
    {
        id: 4,
        title: "Học bổng Kỹ sư Tài năng Fuji Xerox",
        type: "scholarship",
        amount: 15000000,
        unit: "VND",
        cohorts: ["K69", "K68", "K67"],
